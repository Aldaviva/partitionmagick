...
<link href="${pageContext.request.contextPath}/styles/editor.css"
		...
		<table>
			...
			<tbody>
				<c:forEach items="${formData.partitions}" var="partition" varStatus="row">
					<tr>
						<td><form:hidden path="partitions[${row.index }].id"/><form:input path="partitions[${row.index}].environment" /></td>
